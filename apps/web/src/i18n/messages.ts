...
export const englishMessages = {
  ...
  "csv.export.includeZeroStockOne": "Include {count} wine with no bottles",
  "csv.export.includeZeroStockMany": "Include {count} wines with no bottles",
...
export const frenchMessages: Partial<Record<MessageKey, string>> = {
  ...
  "csv.export.includeZeroStockOne": "Inclure {count} vin sans bouteille",
  "csv.export.includeZeroStockMany": "Inclure {count} vins sans bouteille",

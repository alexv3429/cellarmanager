...
<!-- Explain the user-visible or technical change. -->
...
- [ ] `npm run repository:check` passes locally
- [ ] `npm run web:ci` passes locally
- [ ] `npm run supabase -- test db` passes when database behavior is in scope
